...
<p align="center">
  ...
  <a href="https://github.com/LXGIC-Studios/ai-cors/actions">
...
[![License: MIT](https://img.shields.io/npm/l/ai-cors.svg?style=for-the-badge&logo=mit&color=blue)](https://github.com/LXGIC-Studios/ai-cors/blob/main/LICENSE)
...
```bash
git clone https://github.com/LXGIC-Studios/ai-cors.git
cd ai-cors
npm install
npm run dev
```
